...
<%--     <t:dgCol title="状态"  field="status"    queryMode="group"  width="120"></t:dgCol> --%>
    ...
    <t:dgCol title="余额账户"  field="balanceShopping"    queryMode="group"  width="120"></t:dgCol>
...
<%--    <t:dgDelOpt title="删除" url="ctUserController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/> --%>
   ...
   <t:dgToolBar title="禁用" icon="icon-edit" url="ctUserController.do?doUpdate&status=3" funname="updateStatus"></t:dgToolBar>
