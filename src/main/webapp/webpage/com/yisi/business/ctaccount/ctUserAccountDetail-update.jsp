...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ctUserAccountDetailController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountDetailPage.userid}'>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountDetailPage.amount}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountDetailPage.blanceamount}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountDetailPage.moreorless}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountDetailPage.incometype}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  ...
									  ignore="ignore"
									    value='<fmt:formatDate value='${ctUserAccountDetailPage.createtime}' type="date" pattern="yyyy-MM-dd"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountDetailPage.accounttype}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountDetailPage.remark}'>
							<span class="Validform_checktip"></span>
