...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="ctUserAccountDetailList" checkbox="true" pagination="true" fitColumns="false" title="用户账户明细" actionUrl="ctUserAccountDetailController.do?datagrid" idField="id" fit="true" queryMode="group">
