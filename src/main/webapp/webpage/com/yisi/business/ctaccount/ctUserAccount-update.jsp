...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ctUserAccountController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountPage.accounttype}'>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountPage.amount}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountPage.originalamount}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountPage.pointamount}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountPage.scoreamount}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountPage.frozendeposit}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountPage.totalconsumeamount}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountPage.totalinocmeamount}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountPage.incomeamount}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountPage.consumeamount}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${ctUserAccountPage.withdrawtotaldeposit}'>
							<span class="Validform_checktip"></span>
