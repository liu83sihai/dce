...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="loanDictController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
				...
				ignore="checked"
		     	 value='${loanDictPage.createuserid}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				...
				ignore="checked"
		     	 value='${loanDictPage.updateuserid}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="createtime" name="createtime" type="text" style="width: 150px" 
									ignore="checked"
		      						class="Wdate" onClick="WdatePicker()" datatype="*" value='<fmt:formatDate value='${loanDictPage.createtime}' type="date" pattern="yyyy-MM-dd"/>'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					  <input id="updatetime" name="updatetime" type="text" style="width: 150px" 
									ignore="checked"
		      						class="Wdate" onClick="WdatePicker()" datatype="*" value='<fmt:formatDate value='${loanDictPage.updatetime}' type="date" pattern="yyyy-MM-dd"/>'>
				<span class="Validform_checktip"></span>
