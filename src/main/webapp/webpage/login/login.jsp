...
<%@page import="org.jeecgframework.core.util.SysThemesUtil,org.jeecgframework.core.util.ResourceUtil,org.jeecgframework.core.enums.SysThemesEnum"%>
<%@include file="/context/mytags.jsp"%>
<%
  session.setAttribute("lang","zh-cn");
  SysThemesEnum sysTheme = SysThemesUtil.getSysTheme(request);
  String lhgdialogTheme = SysThemesUtil.getLhgdialogTheme(sysTheme);
  String softName = ResourceUtil.getConfigByName("soft.name");
  String softUrl = ResourceUtil.getConfigByName("soft.url");
%>
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="col-sm-10 col-sm-offset-1">
        <div class="login-container">
          <div class="center">
            ...
            <h4 class="blue" id="id-company-text"><%=softUrl %></h4>
          </div>
          ...
          <div class="position-relative">
            ...
            <div class="center"><h4 class="blue" id="id-company-text">&copy; <%=softName%>管理系统版权所有 v_1.0</h4></div>
            <div class="navbar-fixed-top align-right">
              <br />
              &nbsp;
              <a id="btn-login-dark" class="blue" href="apidoc/index.html" >接口地址</a>
              &nbsp;
              <a id="btn-login-dark" class="blue" href="upload/app/dec-anroid.apk" >安卓端下载</a>
              &nbsp;
              <a id="btn-login-dark" class="blue" href="upload/app/dec-ios.apk" >ios端下载</a>
              &nbsp;
            </div>
              </div>
            </div>
